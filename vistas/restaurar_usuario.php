...
<head>
    ...
    <title>Restaurar  Cuenta | <?php echo dataEmpresa("nombre"); ?></title>
                ...
                <div class="row ">
                    ...
                    <div class="col-lg-6 offset-lg-1">
                        <div class="text-center p-5">
                            ...
                            <h3 class="text-uppercase"> Recuperar Cuenta</h3>
                            <p class="text-muted">Bienvenido ! Recupera tu cuenta aqui</p>

                            <form class="login-form mt-4" method="post" id="RestaurarClave">
                                ...
                                <button type="submit" class="btn btn-danger w-100 mt-4">Restaurar Contraseña <i
                                        class="mdi mdi-lock ms-2"></i></button>
                            </form>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="p-5 text-center">
                            ...
                            <h2>Restablecer Usuario | <?php echo dataEmpresa("nombre"); ?></h2>
                        <h5>"Esperamos que puedas realizar las peticiones de una manera optima  "</h5>
                        </div>
