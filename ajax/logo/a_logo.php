...
$sqlimg = $conexionPdo->prepare("UPDATE pm_imgweb SET $img_Aactualizar WHERE nombre_campo='logo'");
...
<?php if ($queryExecute): ?>
	<script>
		$(".img_refresh").attr('src',"../files/logo/<?php echo $nombre_image; ?>");
		$(".img_refresh-logo").attr('src',"../files/logo/<?php echo $nombre_image; ?>");
	</script>
	<img class="imgILogo" style="border-radius: 100px; width: 200px;" src="../files/logo/<?php echo $nombre_image;?>" alt="notFound">
	<br><span class="btn badge-warning ">"La imagen se actualizo exitosamente"...</span>
<?php endif; ?>
